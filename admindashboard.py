...
class adminDashboard:
    def __init__(self,adminDetails):
        ...
        img = Image.open("images/Main_A.jpg")
        ...
        # Add title text
        c.create_text(690 + 13, 35 + 43, text=f"Welcome {self.adminDetails[2]} to your dashboard",
                      font=("Arial", 44, "bold"), fill="#6BBFBF")
        c.create_text(690 + 10, 35 + 40, text=f"Welcome {self.adminDetails[2]} to your dashboard",
                      font=("Arial", 44, "bold"), fill="#208C81")

        viewattendanceBtn = Button(self.root, text="View Record", width=15, height=2,
                               command=lambda: getattendance(), **button_style)
        viewattendanceBtn.place(x=600, y=300)
...
if __name__ == "__main__":
    admin=adminDashboard(adminDetails=(1, 'gagan445@gmail.com', 'Gagan', '99209929233', 'Super Admin'))