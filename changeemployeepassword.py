...
class changePassword:
    def __init__(self,email):
        ...
        self.btn = Button(self.root, text="Change Password", font=self.font, command=self.changePassword,bg=self.button_color, fg="white", activebackground=self.button_hover_color, activeforeground="white")
    ...
    def changePassword(self):
        ...
        if result is None:
            msg.showwarning("Warning", "Email and Password do not match")
        else:
