...
class employeelogin:
    def __init__(self):
        ...
        self.t2= Entry(self.loginForm,font=self.font,bg=self.sec_color,width=27,show='*')
    ...
    def checkAdmin(self):
        ...
        q = f"SELECT employee_id,email,name,mobile FROM employee WHERE email = '{email}' and password = '{password}'"
        self.cr.execute(q)
