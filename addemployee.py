...
class addemployee:
    ...
    #
    #     self.mainLabel = Label(self.root, text="Add Employee", font=("Arial", 24, "bold"),bg=self.bg_color, fg=self.text_color)
    ...
    #
    #     self.btn1 = Button(self.form, text='select', width=10, font=self.font, command=self.selectImage,bg=self.bg_color, fg=self.text_color)
    ...
    #
    #     self.btn = Button(self.root, text='Add', width=20, font=self.font, command=self.addemployee,bg=self.button_color, fg="white", activebackground=self.button_hover_color, activeforeground="white")
    ...
    def __init__(self):
        ...
        self.btn = Button(self.right_frame, text='Add', width=20, font=self.font, command=self.addemployee,
                          bg=self.button_color, fg="white", activebackground=self.button_hover_color,
        ...
        if (name == '' or father_name == '' or email == '' or mobile == '' or
            ...
            if '@' in self.txt3.get() and '.' in self.txt3.get():
                if len(self.txt4.get()) == 10 and self.txt4.get().isdigit():
                    q = ("insert into employee values(null, '" + self.txt1.get() + "','" + self.txt2.get() + "','" + self.txt4.get() +
                                "','" + self.txt3.get() + "','" + self.txt5.get() + "','" + self.txt7.get() + "','" + self.txt6.get() +
                    ...
                    msg.showwarning("Warning", " Enter vaild Mobile Number")
            else:
    ...
    #
    #         else:
    #             msg.showinfo("Success", " Image is Valid")
    #             img_name = f"{name}.png"
    ...
    #     else:
    #         msg.showwarning("Warning", " Enter Name")
    def selectImage(self):
        name = self.txt1.get()
        if len(name) != 0:
            path = askopenfilename()
