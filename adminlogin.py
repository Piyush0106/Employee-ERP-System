...
class adminLogin:
    def __init__(self):
        ...
        self.mainLabel = Label(self.root, text="Admin Login", font=('Arial', 24, 'bold'), bg=self.bg_color, fg=self.text_color)
        ...
        self.t1 = Entry(self.loginForm, font=self.font,bg=self.sec_color,width=27)
        ...
        self.t2 = Entry(self.loginForm, font=self.font, show='*',bg=self.sec_color,width=27)
        self.t2.grid(row=1, column=1, pady=10, padx=20, sticky="e")

        self.loginForm.pack(pady=10)

        self.loginButton = Button(self.root, text="Login", font=self.font, command=self.checkAdmin, bg=self.button_color, fg="white", activebackground=self.button_hover_color, activeforeground="white",width=10)
...
#
#         self.t1 = Entry(self.loginForm, font=self.font, width=30)
#         self.t1.grid(row=0, column=1, pady=10, padx=20)
#
#         self.lb2 = Label(self.loginForm, text="Enter Password", font=self.font, bg=self.bg_color, fg=self.text_color)
#         self.lb2.grid(row=1, column=0, pady=10, padx=20)
#
#         self.t2 = Entry(self.loginForm, font=self.font, width=30, show='*')
